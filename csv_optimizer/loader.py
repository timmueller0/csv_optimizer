...
def load_optimized_dataframe(filename, sample_fraction=0.1, use_float_for_nan_ints=False, use_float_for_nan_bools=False, encoding='latin1', **kwargs):
    """
    ...
    """
    file_sample = pd.read_csv(filename, encoding=encoding, **kwargs).sample(frac=sample_fraction, random_state=1)
